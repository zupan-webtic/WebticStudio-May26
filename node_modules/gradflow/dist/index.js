...
`;function Be(e){let t=Eo.useRef(null),o=Eo.useRef(null),r=Eo.useRef(null),a=Eo.useRef(null),u=Eo.useRef(0),i=Eo.useMemo(()=>({color1:oe(e.color1),color2:oe(e.color2),color3:oe(e.color3)}),[e.color1,e.color2,e.color3]);return Eo.useEffect(()=>{var P;let c=t.current;if(!c)return;let d=new ogl.Renderer({canvas:c,dpr:Math.min(window.devicePixelRatio,2),alpha:false,antialias:false,powerPreference:"high-performance"});o.current=d;let f=d.gl,h=new ogl.Plane(f,{width:2,height:2}),R=()=>{if(!c.parentElement)return;let G=c.parentElement,v=G.clientWidth,w=G.clientHeight,z=Math.min(window.devicePixelRatio,2);c.width=v*z,c.height=w*z,c.style.width=v+"px",c.style.height=w+"px",d.setSize(v,w),r.current&&(r.current.uniforms.u_resolution.value=[v,w]);},M=new ogl.Program(f,{vertex:So,fragment:Io,uniforms:{u_time:{value:0},u_color1:{value:i.color1},u_color2:{value:i.color2},u_color3:{value:i.color3},u_speed:{value:e.speed},u_scale:{value:e.scale},u_type:{value:ee[(P=e.type)!=null?P:"animated"]},u_noise:{value:e.noise},u_resolution:{value:[c.clientWidth,c.clientHeight]}}});r.current=M;let T=new ogl.Mesh(f,{geometry:h,program:M});a.current=T;let y=new ogl.Transform;T.setParent(y),R(),window.addEventListener("resize",R,{passive:true});let k=performance.now(),A=G=>{let v=(G-k)/1e3;M.uniforms.u_time.value=v,d.render({scene:T}),u.current=requestAnimationFrame(A);};return u.current=requestAnimationFrame(A),()=>{var v,w;cancelAnimationFrame(u.current),window.removeEventListener("resize",R);let G=(v=o.current)==null?void 0:v.gl;(w=r.current)!=null&&w.program&&G&&G.deleteProgram(r.current.program),o.current=null,r.current=null,a.current=null;}},[]),Eo.useEffect(()=>{var d;let c=r.current;c&&(c.uniforms.u_color1.value=i.color1,c.uniforms.u_color2.value=i.color2,c.uniforms.u_color3.value=i.color3,c.uniforms.u_speed.value=e.speed,c.uniforms.u_scale.value=e.scale,c.uniforms.u_type.value=ee[(d=e.type)!=null?d:"animated"],c.uniforms.u_noise.value=e.noise);},[e,i]),{canvasRef:t,rendererRef:o,programRef:r,meshRef:a}}function Ve(e){let t=e.replace("#",""),o=parseInt(t,16),r=o>>16&255,a=o>>8&255,u=o&255;return {r,g:a,b:u}}function Co(e){let{r:t,g:o,b:r}=e;return "#"+((1<<24)+(t<<16)+(o<<8)+r).toString(16).slice(1)}function H(e){return typeof e=="string"?Ve(e):e}function de({config:e,className:t=""}){let o=Eo.useMemo(()=>{let a=K({},ce);return e&&(e.color1&&(a.color1=H(e.color1)),e.color2&&(a.color2=H(e.color2)),e.color3&&(a.color3=H(e.color3)),e.speed!==void 0&&(a.speed=e.speed),e.scale!==void 0&&(a.scale=e.scale),e.type&&(a.type=e.type),e.noise!==void 0&&(a.noise=e.noise)),a},[e]),{canvasRef:r}=Be(o);return Eo__default.default.createElement("canvas",{ref:r,className:Oe("w-full h-full block select-none touch-none",t),"aria-label":"gradflow animated gradient background"})}function re(){return {r:Math.floor(Math.random()*256),g:Math.floor(Math.random()*256),b:Math.floor(Math.random()*256)}}function Fo(){return {color1:re(),color2:re(),color3:re()}}exports.DEFAULT_CONFIG=ce;exports.GRADIENT_TYPE_NUMBER=ee;exports.GradFlow=de;exports.PRESETS=Ro;exports.default=de;exports.generateRandomColors=Fo;exports.hexToRgb=Ve;exports.normalizeColor=H;exports.randomRGB=re;exports.rgbToHex=Co;